...
@rem ##########################################################################
@rem
@rem  multi-tech-vis startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute multi-tech-vis
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" org.mtv.Launcher %CMD_LINE_ARGS%
